...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "C_S00_AXI_MEM_INSTR_MAX"

}

proc update_PARAM_VALUE.C_S00_AXI_MEM_DATA_MAX { PARAM_VALUE.C_S00_AXI_MEM_DATA_MAX } {
	# Procedure called to update C_S00_AXI_MEM_DATA_MAX when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_S00_AXI_MEM_DATA_MAX { PARAM_VALUE.C_S00_AXI_MEM_DATA_MAX } {
	# Procedure called to validate C_S00_AXI_MEM_DATA_MAX
	return true
}

proc update_PARAM_VALUE.C_S00_AXI_MEM_DATA_MIN { PARAM_VALUE.C_S00_AXI_MEM_DATA_MIN } {
	# Procedure called to update C_S00_AXI_MEM_DATA_MIN when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_S00_AXI_MEM_DATA_MIN { PARAM_VALUE.C_S00_AXI_MEM_DATA_MIN } {
	# Procedure called to validate C_S00_AXI_MEM_DATA_MIN
	return true
}

proc update_PARAM_VALUE.C_S00_AXI_MEM_INSTR_MAX { PARAM_VALUE.C_S00_AXI_MEM_INSTR_MAX } {
	# Procedure called to update C_S00_AXI_MEM_INSTR_MAX when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_S00_AXI_MEM_INSTR_MAX { PARAM_VALUE.C_S00_AXI_MEM_INSTR_MAX } {
	# Procedure called to validate C_S00_AXI_MEM_INSTR_MAX
	return true
}

proc update_PARAM_VALUE.C_S00_AXI_MEM_INSTR_MIN { PARAM_VALUE.C_S00_AXI_MEM_INSTR_MIN } {
	# Procedure called to update C_S00_AXI_MEM_INSTR_MIN when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_S00_AXI_MEM_INSTR_MIN { PARAM_VALUE.C_S00_AXI_MEM_INSTR_MIN } {
	# Procedure called to validate C_S00_AXI_MEM_INSTR_MIN
	return true
}
...
proc update_MODELPARAM_VALUE.C_S00_AXI_MEM_INSTR_MIN { MODELPARAM_VALUE.C_S00_AXI_MEM_INSTR_MIN PARAM_VALUE.C_S00_AXI_MEM_INSTR_MIN } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_S00_AXI_MEM_INSTR_MIN}] ${MODELPARAM_VALUE.C_S00_AXI_MEM_INSTR_MIN}
}

proc update_MODELPARAM_VALUE.C_S00_AXI_MEM_INSTR_MAX { MODELPARAM_VALUE.C_S00_AXI_MEM_INSTR_MAX PARAM_VALUE.C_S00_AXI_MEM_INSTR_MAX } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_S00_AXI_MEM_INSTR_MAX}] ${MODELPARAM_VALUE.C_S00_AXI_MEM_INSTR_MAX}
}

proc update_MODELPARAM_VALUE.C_S00_AXI_MEM_DATA_MIN { MODELPARAM_VALUE.C_S00_AXI_MEM_DATA_MIN PARAM_VALUE.C_S00_AXI_MEM_DATA_MIN } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_S00_AXI_MEM_DATA_MIN}] ${MODELPARAM_VALUE.C_S00_AXI_MEM_DATA_MIN}
}

proc update_MODELPARAM_VALUE.C_S00_AXI_MEM_DATA_MAX { MODELPARAM_VALUE.C_S00_AXI_MEM_DATA_MAX PARAM_VALUE.C_S00_AXI_MEM_DATA_MAX } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_S00_AXI_MEM_DATA_MAX}] ${MODELPARAM_VALUE.C_S00_AXI_MEM_DATA_MAX}
}
